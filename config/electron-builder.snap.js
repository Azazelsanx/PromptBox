...
module.exports = {
  ...
  linux: {
    ...
    description: [
      'PromptBox 是一款隐私优先的 AI 提示词管理工具，帮助你创建、整理、复用和持续优化自己的提示词。',
      '',
      '提示词库默认保存在本机。你可以使用变量和 Jinja 模板复用提示词，通过分类、标签、评分和收藏整理内容，并用历史记录回顾使用过程。PromptBox 支持 Ollama、LM Studio 等本地模型，也支持由你自行配置的在线 AI 服务。',
      '',
